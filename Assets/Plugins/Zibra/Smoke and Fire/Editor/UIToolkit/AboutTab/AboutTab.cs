...
using com.zibraai.smoke_and_fire.Foundation.UIElements;
...
namespace com.zibraai.smoke_and_fire.Plugins.Editor
{
    internal class AboutTab : BaseTab
    {
        ...
        {
            // TODO replace link
            Application.OpenURL("https://zibra.ai/");
        }
        ...
        private void OnAuthKeyBtnOnClickedHandler()
        {
            ...
            {
                EditorUtility.DisplayDialog("Zibra Smoke & Fire Key Error", "Incorrect key format.", "Ok");
            }
        }
#endif
    }
